package com.pppspringioc.ioc.annotationbasedcontainerconfiguration.customautowire.config;
...
@Configuration
@ComponentScan(basePackages = "com.pppspringioc.ioc.annotationbasedcontainerconfiguration.customautowire")
